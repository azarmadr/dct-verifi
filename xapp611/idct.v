...
The outputs of the 8 bit shift registers are registered at every  8th clock
This will enable us to register in 8 pixels (one row) at atime
...
output [7:0] idct_2d/*verilator sc_bv*/;
input CLK, RST,rdy_in;
input[11:0] dct_2d/*verilator sc_bv*/;
wire[7:0] idct_2d;
