...
void Vdct::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+8,"dct z_out_int", false,-1, 18,0);
        tracep->declBit(c+2,"dct CLK", false,-1);
        tracep->declBit(c+3,"dct RST", false,-1);
        tracep->declBus(c+4,"dct xin", false,-1, 7,0);
        tracep->declBit(c+9,"dct rdy_out", false,-1);
        tracep->declBus(c+10,"dct memory1a", false,-1, 7,0);
        tracep->declBus(c+11,"dct memory2a", false,-1, 7,0);
        tracep->declBus(c+12,"dct memory3a", false,-1, 7,0);
        tracep->declBus(c+13,"dct memory4a", false,-1, 7,0);
        tracep->declBus(c+14,"dct xa0_in", false,-1, 7,0);
        tracep->declBus(c+15,"dct xa1_in", false,-1, 7,0);
        tracep->declBus(c+16,"dct xa2_in", false,-1, 7,0);
        tracep->declBus(c+17,"dct xa3_in", false,-1, 7,0);
        tracep->declBus(c+18,"dct xa4_in", false,-1, 7,0);
        tracep->declBus(c+19,"dct xa5_in", false,-1, 7,0);
        tracep->declBus(c+20,"dct xa6_in", false,-1, 7,0);
        tracep->declBus(c+21,"dct xa7_in", false,-1, 7,0);
        tracep->declBus(c+22,"dct xa0_reg", false,-1, 8,0);
        tracep->declBus(c+23,"dct xa1_reg", false,-1, 8,0);
        tracep->declBus(c+24,"dct xa2_reg", false,-1, 8,0);
        tracep->declBus(c+25,"dct xa3_reg", false,-1, 8,0);
        tracep->declBus(c+26,"dct xa4_reg", false,-1, 8,0);
        tracep->declBus(c+27,"dct xa5_reg", false,-1, 8,0);
        tracep->declBus(c+28,"dct xa6_reg", false,-1, 8,0);
        tracep->declBus(c+29,"dct xa7_reg", false,-1, 8,0);
        tracep->declBus(c+30,"dct add_sub1a", false,-1, 8,0);
        tracep->declBus(c+31,"dct add_sub2a", false,-1, 8,0);
        tracep->declBus(c+32,"dct add_sub3a", false,-1, 8,0);
        tracep->declBus(c+33,"dct add_sub4a", false,-1, 8,0);
        tracep->declBus(c+34,"dct addsub1a_comp", false,-1, 7,0);
        tracep->declBus(c+35,"dct addsub2a_comp", false,-1, 7,0);
        tracep->declBus(c+36,"dct addsub3a_comp", false,-1, 7,0);
        tracep->declBus(c+37,"dct addsub4a_comp", false,-1, 7,0);
        tracep->declBit(c+38,"dct save_sign1a", false,-1);
        tracep->declBit(c+39,"dct save_sign2a", false,-1);
        tracep->declBit(c+40,"dct save_sign3a", false,-1);
        tracep->declBit(c+41,"dct save_sign4a", false,-1);
        tracep->declBus(c+42,"dct p1a", false,-1, 18,0);
        tracep->declBus(c+43,"dct p2a", false,-1, 18,0);
        tracep->declBus(c+44,"dct p3a", false,-1, 18,0);
        tracep->declBus(c+45,"dct p4a", false,-1, 18,0);
        tracep->declQuad(c+46,"dct p1a_all", false,-1, 35,0);
        tracep->declQuad(c+48,"dct p2a_all", false,-1, 35,0);
        tracep->declQuad(c+50,"dct p3a_all", false,-1, 35,0);
        tracep->declQuad(c+52,"dct p4a_all", false,-1, 35,0);
        tracep->declBus(c+54,"dct i_wait", false,-1, 1,0);
        tracep->declBit(c+55,"dct toggleA", false,-1);
        tracep->declBus(c+56,"dct z_out_int1", false,-1, 18,0);
        tracep->declBus(c+57,"dct z_out_int2", false,-1, 18,0);
...
void Vdct::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullSData(oldp+7,((0xfffU & ((0x80U 
                                              ...
                                              : (vlTOPp->dct__DOT__dct_2d_int 
                                                 >> 8U)))),12);
        tracep->fullIData(oldp+8,(vlTOPp->__Vcellout__dct__z_out_int),19);
        tracep->fullBit(oldp+9,((0x5eU == (IData)(vlTOPp->dct__DOT__cntr92))));
        tracep->fullCData(oldp+10,(vlTOPp->dct__DOT__memory1a),8);
        tracep->fullCData(oldp+11,(vlTOPp->dct__DOT__memory2a),8);
        tracep->fullCData(oldp+12,(vlTOPp->dct__DOT__memory3a),8);
        tracep->fullCData(oldp+13,(vlTOPp->dct__DOT__memory4a),8);
        tracep->fullCData(oldp+14,(vlTOPp->dct__DOT__xa0_in),8);
        tracep->fullCData(oldp+15,(vlTOPp->dct__DOT__xa1_in),8);
        tracep->fullCData(oldp+16,(vlTOPp->dct__DOT__xa2_in),8);
        tracep->fullCData(oldp+17,(vlTOPp->dct__DOT__xa3_in),8);
        tracep->fullCData(oldp+18,(vlTOPp->dct__DOT__xa4_in),8);
        tracep->fullCData(oldp+19,(vlTOPp->dct__DOT__xa5_in),8);
        tracep->fullCData(oldp+20,(vlTOPp->dct__DOT__xa6_in),8);
        tracep->fullCData(oldp+21,(vlTOPp->dct__DOT__xa7_in),8);
        tracep->fullSData(oldp+22,(vlTOPp->dct__DOT__xa0_reg),9);
        tracep->fullSData(oldp+23,(vlTOPp->dct__DOT__xa1_reg),9);
        tracep->fullSData(oldp+24,(vlTOPp->dct__DOT__xa2_reg),9);
        tracep->fullSData(oldp+25,(vlTOPp->dct__DOT__xa3_reg),9);
        tracep->fullSData(oldp+26,(vlTOPp->dct__DOT__xa4_reg),9);
        tracep->fullSData(oldp+27,(vlTOPp->dct__DOT__xa5_reg),9);
        tracep->fullSData(oldp+28,(vlTOPp->dct__DOT__xa6_reg),9);
        tracep->fullSData(oldp+29,(vlTOPp->dct__DOT__xa7_reg),9);
        tracep->fullSData(oldp+30,(vlTOPp->dct__DOT__add_sub1a),9);
        tracep->fullSData(oldp+31,(vlTOPp->dct__DOT__add_sub2a),9);
        tracep->fullSData(oldp+32,(vlTOPp->dct__DOT__add_sub3a),9);
        tracep->fullSData(oldp+33,(vlTOPp->dct__DOT__add_sub4a),9);
        tracep->fullCData(oldp+34,(vlTOPp->dct__DOT__addsub1a_comp),8);
        tracep->fullCData(oldp+35,(vlTOPp->dct__DOT__addsub2a_comp),8);
        tracep->fullCData(oldp+36,(vlTOPp->dct__DOT__addsub3a_comp),8);
        tracep->fullCData(oldp+37,(vlTOPp->dct__DOT__addsub4a_comp),8);
        tracep->fullBit(oldp+38,(vlTOPp->dct__DOT__save_sign1a));
        tracep->fullBit(oldp+39,(vlTOPp->dct__DOT__save_sign2a));
        tracep->fullBit(oldp+40,(vlTOPp->dct__DOT__save_sign3a));
        tracep->fullBit(oldp+41,(vlTOPp->dct__DOT__save_sign4a));
        tracep->fullIData(oldp+42,(vlTOPp->dct__DOT__p1a),19);
        tracep->fullIData(oldp+43,(vlTOPp->dct__DOT__p2a),19);
        tracep->fullIData(oldp+44,(vlTOPp->dct__DOT__p3a),19);
        tracep->fullIData(oldp+45,(vlTOPp->dct__DOT__p4a),19);
        tracep->fullQData(oldp+46,(vlTOPp->dct__DOT__p1a_all),36);
        tracep->fullQData(oldp+48,(vlTOPp->dct__DOT__p2a_all),36);
        tracep->fullQData(oldp+50,(vlTOPp->dct__DOT__p3a_all),36);
        tracep->fullQData(oldp+52,(vlTOPp->dct__DOT__p4a_all),36);
        tracep->fullCData(oldp+54,(vlTOPp->dct__DOT__i_wait),2);
        tracep->fullBit(oldp+55,(vlTOPp->dct__DOT__toggleA));
        tracep->fullIData(oldp+56,(vlTOPp->dct__DOT__z_out_int1),19);
        tracep->fullIData(oldp+57,(vlTOPp->dct__DOT__z_out_int2),19);
