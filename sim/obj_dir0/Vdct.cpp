...
VL_INLINE_OPT QData Vdct::_change_request_1(Vdct__Syms* __restrict vlSymsp) {
    ...
    VL_DEBUG_IF( if(__req && ((vlTOPp->__Vcellinp__dct__RST ^ vlTOPp->__Vchglast__TOP____Vcellinp__dct__RST))) VL_DBG_MSGF("        CHANGE: ../backup/dct.v:90: __Vcellinp__dct__RST\n"); );
    // Final
