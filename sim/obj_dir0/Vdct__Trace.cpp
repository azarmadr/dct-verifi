    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[2U])) {
            tracep->chgSData(oldp+6,((0xfffU & ((0x80U 
                                                ...
                                                (vlTOPp->dct__DOT__dct_2d_int 
                                                 >> 8U)))),12);
            tracep->chgIData(oldp+7,(vlTOPp->__Vcellout__dct__z_out_int),19);
            tracep->chgBit(oldp+8,((0x5eU == (IData)(vlTOPp->dct__DOT__cntr92))));
            tracep->chgCData(oldp+9,(vlTOPp->dct__DOT__memory1a),8);
            tracep->chgCData(oldp+10,(vlTOPp->dct__DOT__memory2a),8);
            tracep->chgCData(oldp+11,(vlTOPp->dct__DOT__memory3a),8);
            tracep->chgCData(oldp+12,(vlTOPp->dct__DOT__memory4a),8);
            tracep->chgCData(oldp+13,(vlTOPp->dct__DOT__xa0_in),8);
            tracep->chgCData(oldp+14,(vlTOPp->dct__DOT__xa1_in),8);
            tracep->chgCData(oldp+15,(vlTOPp->dct__DOT__xa2_in),8);
            tracep->chgCData(oldp+16,(vlTOPp->dct__DOT__xa3_in),8);
            tracep->chgCData(oldp+17,(vlTOPp->dct__DOT__xa4_in),8);
            tracep->chgCData(oldp+18,(vlTOPp->dct__DOT__xa5_in),8);
            tracep->chgCData(oldp+19,(vlTOPp->dct__DOT__xa6_in),8);
            tracep->chgCData(oldp+20,(vlTOPp->dct__DOT__xa7_in),8);
            tracep->chgSData(oldp+21,(vlTOPp->dct__DOT__xa0_reg),9);
            tracep->chgSData(oldp+22,(vlTOPp->dct__DOT__xa1_reg),9);
            tracep->chgSData(oldp+23,(vlTOPp->dct__DOT__xa2_reg),9);
            tracep->chgSData(oldp+24,(vlTOPp->dct__DOT__xa3_reg),9);
            tracep->chgSData(oldp+25,(vlTOPp->dct__DOT__xa4_reg),9);
            tracep->chgSData(oldp+26,(vlTOPp->dct__DOT__xa5_reg),9);
            tracep->chgSData(oldp+27,(vlTOPp->dct__DOT__xa6_reg),9);
            tracep->chgSData(oldp+28,(vlTOPp->dct__DOT__xa7_reg),9);
            tracep->chgSData(oldp+29,(vlTOPp->dct__DOT__add_sub1a),9);
            tracep->chgSData(oldp+30,(vlTOPp->dct__DOT__add_sub2a),9);
            tracep->chgSData(oldp+31,(vlTOPp->dct__DOT__add_sub3a),9);
            tracep->chgSData(oldp+32,(vlTOPp->dct__DOT__add_sub4a),9);
            tracep->chgCData(oldp+33,(vlTOPp->dct__DOT__addsub1a_comp),8);
            tracep->chgCData(oldp+34,(vlTOPp->dct__DOT__addsub2a_comp),8);
            tracep->chgCData(oldp+35,(vlTOPp->dct__DOT__addsub3a_comp),8);
            tracep->chgCData(oldp+36,(vlTOPp->dct__DOT__addsub4a_comp),8);
            tracep->chgBit(oldp+37,(vlTOPp->dct__DOT__save_sign1a));
            tracep->chgBit(oldp+38,(vlTOPp->dct__DOT__save_sign2a));
            tracep->chgBit(oldp+39,(vlTOPp->dct__DOT__save_sign3a));
            tracep->chgBit(oldp+40,(vlTOPp->dct__DOT__save_sign4a));
            tracep->chgIData(oldp+41,(vlTOPp->dct__DOT__p1a),19);
            tracep->chgIData(oldp+42,(vlTOPp->dct__DOT__p2a),19);
            tracep->chgIData(oldp+43,(vlTOPp->dct__DOT__p3a),19);
            tracep->chgIData(oldp+44,(vlTOPp->dct__DOT__p4a),19);
            tracep->chgQData(oldp+45,(vlTOPp->dct__DOT__p1a_all),36);
            tracep->chgQData(oldp+47,(vlTOPp->dct__DOT__p2a_all),36);
            tracep->chgQData(oldp+49,(vlTOPp->dct__DOT__p3a_all),36);
            tracep->chgQData(oldp+51,(vlTOPp->dct__DOT__p4a_all),36);
            tracep->chgCData(oldp+53,(vlTOPp->dct__DOT__i_wait),2);
            tracep->chgBit(oldp+54,(vlTOPp->dct__DOT__toggleA));
            tracep->chgIData(oldp+55,(vlTOPp->dct__DOT__z_out_int1),19);
            tracep->chgIData(oldp+56,(vlTOPp->dct__DOT__z_out_int2),19);
